...
--
-- Host: localhost    Database: timecraft
-- ------------------------------------------------------
...
--
-- Table structure for table `item_template_ability`
--

DROP TABLE IF EXISTS `item_template_ability`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `item_template_ability` (
  `item_template_id` bigint(20) NOT NULL,
  `ability_id` bigint(20) NOT NULL,
  `points_provided` int(11) NOT NULL,
  PRIMARY KEY (`item_template_id`,`ability_id`),
  KEY `item_template_id` (`ability_id`),
  CONSTRAINT `item_template_ability_ibfk_1` FOREIGN KEY (`item_template_id`) REFERENCES `item_template` (`id`) ON DELETE CASCADE,
  CONSTRAINT `item_template_ability_ibfk_2` FOREIGN KEY (`ability_id`) REFERENCES `ability` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5927 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `player_energy_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `player_energy_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `player_id` int(11) NOT NULL,
  `reason` enum('Food','Sleep','Special') NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=3477 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-07-29  1:58:29
