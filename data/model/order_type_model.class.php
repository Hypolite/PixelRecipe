  ...
  public function html_get_form() {
    ...
    <fieldset>
      <legend>Text fields</legend>
        ...
        <p class="field">'.(is_array($this->get_class_name())?
          HTMLHelper::genererTextArea( "class_name", parameters_to_string( $this->get_class_name() ), array(), "Class Name *" ):
          HTMLHelper::genererInputText( "class_name", $this->get_class_name(), array(), "Class Name *")).'
        </p>
