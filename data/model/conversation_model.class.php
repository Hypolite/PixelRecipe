  ...
  public function html_get_form() {
    ...
    <fieldset>
      ...
      <p class="field">'.HTMLHelper::genererSelect('player_id', $option_list, $this->get_player_id(), array(), "Player Id *").'<a href="'.get_page_url('admin_player_mod').'">Créer un objet Player</a></p>
        <p class="field">'.(is_array($this->get_game_id())?
          HTMLHelper::genererTextArea( "game_id", parameters_to_string( $this->get_game_id() ), array(), "Game Id" ):
          HTMLHelper::genererInputText( "game_id", $this->get_game_id(), array(), "Game Id")).'
        </p>
